...
path <- "C:/Users/edwar/OneDrive/Documents/FEISummer2021/CreditContractStrictnessProfBattaSum2021/Scraping/data/Bunge Ltd.xlsx"
...
Indebtedness_def_data_ori$Sign<-c(NA,1,1,1,1,1,1,1,1,1)
...
Bunge_LTD_Indebtedness_def_data_new<-add_new_columns(Indebtedness_def_data_ori, "Indebtedness Definition", "Indebtedness Definition")
Bunge_LTD_Restricted_Payments_data_new<-add_new_columns(Restricted_Payments_data_ori, "Restricted Payments", "Restricted Payments Definition")

#selecting columns we want to keep
#Indebtedness Definition
Bunge_LTD_Indebtedness_def_data_new <- Bunge_LTD_Indebtedness_def_data_new %>% 
  select(c(IntelligizeID, Item, `Specific Definition`, Text, Sign, Category))

#Restricted Payments
Bunge_LTD_Restricted_Payments_data_new<-Bunge_LTD_Restricted_Payments_data_new %>% 
